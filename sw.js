...
const CACHE_NAME = 'lianails-v49';
const urlsToCache = [
  '/lianails/',
  '/lianails/index.html',
  '/lianails/admin.html',
  '/lianails/admin-login.html',
  '/lianails/calendar.html',
  ...
  '/lianails/vendor/react.production.min.js',
  '/lianails/vendor/react-dom.production.min.js',
  '/lianails/vendor/babel.min.js',
  '/lianails/vendor/bcrypt.min.js',
  '/lianails/vendor/tailwind-browser.js',
  '/lianails/vendor/lucide/lucide.css',
  '/lianails/vendor/lucide/lucide.woff2',
  '/lianails/utils/push-config.js',
  '/lianails/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/lianails/icons/icon-192x192.png',
    badge: '/lianails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/lianails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/lianails/admin.html';
  event.waitUntil(
